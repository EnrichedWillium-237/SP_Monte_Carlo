...
void plotCent() {
    ...
    double q1q2data_val[] = {0.00637517, 0.0147806, 0.021981, 0.0277716, 0.0321126, 0.0353775, 0.037362, 0.0380047, 0.0365756, 0.029996, 0.0203142};
    ...
    double q1q2toyOddZero_val[] = {};
    double q1q2toyOddZero_err[] = {};
